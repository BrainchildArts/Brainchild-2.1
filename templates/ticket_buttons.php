  ...
  <?php while( have_rows('ticket_buttons') ): the_row();
    ...
    ?>
      ...
      <?php if( $status == 'Active' ){ ?>
        ...
        <div class="active-tier"><a class="cta button ticket-link" href="https://www.tickettailor.com/events/brainchildfestival/231651/r/website" target="_blank"><?php echo $text ?></a></div>
