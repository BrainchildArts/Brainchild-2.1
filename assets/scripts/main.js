  ...
  var Sage = {
    ...
    'common': {
      init: function() {
        ...
        //Thumbnail Grid used for Lineup

        var Grid = (function() {

            // list of items
          var $grid = $( '#artist__grid' ),
            // the items
            $items = $grid.children( '.post' ),
          ...
          Preview.prototype = {
            create : function() {
              ...
              this.$details = $( '<div class="artist__details"></div>' ).append( this.$title, this.$description, this.$href );
              this.$loading = $( '<div class="artist__loading"></div>' );
              this.$fullimage = $( '<div class="artist__fullimg"></div>' ).append( this.$loading );
              this.$closePreview = $( '<span class="artist__close"></span>' );
              this.$previewInner = $( '<div class="artist__expander-inner"></div>' ).append( this.$closePreview, this.$fullimage, this.$details );
              this.$previewEl = $( '<div class="artist__expander"></div>' ).append( this.$previewInner );
